# -*- coding: utf-8 -*-
"""
Created on Wed Jan 15 18:47:10 2020
...
'''
[major_events, stationary_events, rainflow_events, tao] = model.RBA_theta(data=wind_data,
                                                                             nominal=2.5,
                                                                             s=0.01,
                                                                             k=3,
                                                                             fc=0.1,
...
save_xls(major_events, f'test_results/shortset/major_events_T_0.1_shortset.xlsx')
...
for t in thresholds:
    ...
    major_events["Turbine_1"].describe().to_excel(writer)
    writer.save()
